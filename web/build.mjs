...
// Beautiful UI ships Inter + JetBrains Mono; fonts.css inlines the latin subsets
// (variable weight) as base64 data: URIs so the single-file PWA needs no network.
let css = "";
try { css = readFileSync(join(HERE, "src", "fonts.css"), "utf8") + "\n"; } catch {}
